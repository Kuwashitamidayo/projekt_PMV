...
class App(QDialog):
    ...
    def initClothingLevelElementList(self):
        self.qCloLevelList.addItem("0,50 - Typowy ubiór letni")
        self.qCloLevelList.addItem("1,00 - Typowy zimowy ubiór (w budynku)")
        self.qCloLevelList.addItem("0,57 - T-shirt, spodnie")
        self.qCloLevelList.addItem("0,61 - Koszula, spodnie")
        self.qCloLevelList.addItem("0,96 - Kurtka, koszula, spodnie")
        self.qCloLevelList.addItem("0,54 - Spódniczka do kolan, koszulka")
        self.qCloLevelList.addItem("0,36 - Spodenki, T-shirt")
        self.qCloLevelList.addItem("0,74 - Dres, długi rękaw")
